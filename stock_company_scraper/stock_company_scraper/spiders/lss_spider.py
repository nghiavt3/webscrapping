...
class EventSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ('https://lasuco.vn/category/thong-tin-co-dong/thong-tin-tai-chinh/', self.parse_generic),
            ('https://lasuco.vn/category/thong-tin-co-dong/dai-hoi-dong-co-dong/', self.parse_generic),
            ('https://lasuco.vn/category/thong-tin-co-dong/hoi-dong-quan-tri/', self.parse_generic),
    ...
    def parse_generic(self, response):
        ...
        for article in articles:        
            title = article.css('.elementor-post__title a::text').get(default='').strip()
