...
class EventSpider(scrapy.Spider):
    name = 'event_dvm'
    mcpcty = 'DVM' 
    allowed_domains = ['duoclieuvietnam.com.vn'] 
    ...
    def start_requests(self):
        urls = [
            ('https://duoclieuvietnam.com.vn/vi/download/', self.parse_generic),
    ...
    def parse_generic(self, response):
        ...
        for item in response.css('div.divTable div.item'):        
            title = item.css('span.title::text').get()
            date = item.css('div.date_issued::text').get()
