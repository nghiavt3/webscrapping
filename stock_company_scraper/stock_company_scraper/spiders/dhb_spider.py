...
class EventSpider(scrapy.Spider):
    ...
    start_urls = ['https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=DHB&pageSize=8&selectedPage=1&cbtt=1&from=01-01-1970&to=01-01-3000&newsType=1',
                  'https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=DHB&pageSize=8&selectedPage=1&cbtt=0&from=01-01-1970&to=01-01-3000&newsType=1'] 
