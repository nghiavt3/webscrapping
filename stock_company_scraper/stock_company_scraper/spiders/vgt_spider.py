...
class EventSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for item in news_items:
            ...
            # Lấy ngày xuất bản
            date_pub = item.get("DatePub") # Ví dụ: "18/11/2025 15:14"
            
            # Lấy URL của file PDF đính kèm (là URL chính xác)
            # Thay thế các ký tự escape '\' trong URL bằng '/'
