...
class EventSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ('https://www.pvpnt2.vn/quan-he-co-dong/cong-bo-thong-tin', self.parse_generic),
            ('https://www.pvpnt2.vn/quan-he-co-dong/thong-tin-co-dong', self.parse_generic),
    ...
    def parse_generic(self, response):
        ...
        for row in rows:
            ...
            date_str = row.css('td.text-center time::text').get()
