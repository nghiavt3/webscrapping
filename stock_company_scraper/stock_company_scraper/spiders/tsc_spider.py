...
class EventSpider(scrapy.Spider):
    name = 'event_tsc'
    mcpcty = 'TSC' 
    allowed_domains = ['fitgroup.com.vn'] 
    ...
    def start_requests(self):
        urls = [
            ('https://fitgroup.com.vn/quan-he-co-dong/dai-hoi-dong-co-dong/', self.parse_generic),
            ('https://fitgroup.com.vn/quan-he-co-dong/cong-bo-thong-tin-khac/', self.parse_generic),
             ('https://fitgroup.com.vn/quan-he-co-dong/bao-cao-tai-chinh/', self.parse_generic),
    ...
    def parse_generic(self, response):
       ...
       # cursor.execute(f'''DROP TABLE IF EXISTS {table_name}''')
        ...
        ''')
        for row in response.css('.item tbody tr'):
