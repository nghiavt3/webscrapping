...
class EventSpider(scrapy.Spider):
    ...
    async def start(self):
        urls = [
            ('https://www.vilico.vn/thong-tin-khac/', self.parse_generic),
            ('https://www.vilico.vn/bao-cao-tai-chinh/', self.parse_generic),
            ('https://www.vilico.vn/dai-hoi-co-dong/', self.parse_generic),
        ...
        for url, callback in urls:
            yield scrapy.Request(
                ...
                "playwright_page_methods": [
                    # Đợi 3 giây để bypass các script kiểm tra bot
                    PageMethod("wait_for_timeout", 3000),
                    # Cuộn xuống một chút để giống người dùng thật
    ...
    async def parse_generic(self, response):
        ...
        rows = response.css('table.daihoicodong tbody tr')
