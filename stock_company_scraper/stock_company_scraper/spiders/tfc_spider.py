...
class EventSpider(scrapy.Spider):
    ...
    start_urls = ['https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=TFC&pageSize=8&selectedPage=1&cbtt=1&from=01-01-1970&to=01-01-3000&newsType=1',
                  'https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=TFC&pageSize=8&selectedPage=1&cbtt=0&from=01-01-1970&to=01-01-3000&newsType=1'] 
    ...
    async def parse(self, response):
        ...
        try:
            ...
            self.logger.error("Lỗi: Không thể giải mã JSON từ API!")
            return
...
def convert_date_to_iso8601(vietnam_date_str):
    if not vietnam_date_str:
        return None
    try:
        # Cắt bỏ miligiây sau dấu chấm và parse theo định dạng API
