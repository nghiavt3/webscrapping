...
class EventSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for item in list_items:
            ...
            # Chọn thẻ <a> bên trong <li> và lấy nội dung text.
            title = item.css('a::text').get(default='').strip()

            # 3. Trích xuất Liên kết URL (đường dẫn tải về/xem chi tiết)
            # Chọn thẻ <a> bên trong <li> và lấy giá trị của thuộc tính 'href'.
