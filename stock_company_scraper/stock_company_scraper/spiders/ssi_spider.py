...
class EventSpider(scrapy.Spider):
    ...
    #start_urls = ['https://www.ssi.com.vn/quan-he-nha-dau-tu/cong-bo-thong-tin','https://www.ssi.com.vn/quan-he-nha-dau-tu/bao-cao-tai-chinh'] 

    
    async def start(self):
        urls = [
            ('https://www.ssi.com.vn/quan-he-nha-dau-tu/cong-bo-thong-tin', self.parse),
            ('https://www.ssi.com.vn/quan-he-nha-dau-tu/bao-cao-tai-chinh', self.parse_generic),
        ]
    ...
    def parse_generic(self, response):
        ...
        # 2. Chọn tất cả các khối tin tức
        items = response.css('div.chart__content__item')

        for item in items:
            # Trích xuất dữ liệu
            title = item.css('div.chart__content__item__desc p::text').get()
            url = item.css('div.chart__content__item__time a::attr(href)').get()
