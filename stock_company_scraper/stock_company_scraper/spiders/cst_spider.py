...
class EventSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ('https://thancaoson.vn/category/quan-he-co-dong/thong-tin-cong-bo-bat-thuong/', self.parse_generic),
             ('https://thancaoson.vn/category/quan-he-co-dong/bao-cao-tai-chinh/', self.parse_generic),
              ('https://thancaoson.vn/category/quan-he-co-dong/bao-cao-thuong-nien/', self.parse_generic),
    ...
    def parse_generic(self, response):
        ...
        for post in response.css('div.post-item'):          
            ...
            date = post.css('div.post-time::text').get()
