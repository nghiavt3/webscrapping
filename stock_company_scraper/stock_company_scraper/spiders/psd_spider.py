...
class EventSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for item in items:
            ...
            e_item['date'] = convert_date_to_iso8601(date_text.strip())
            yield e_item
