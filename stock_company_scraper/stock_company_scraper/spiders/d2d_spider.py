...
class EventSpider(scrapy.Spider):
    ...
    # API URL lấy danh sách công bố thông tin cho mã D2D
    start_urls = [
        'https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=D2D&pageSize=8&selectedPage=1&cbtt=0&from=01-01-1970&to=01-01-3000&newsType=1',
        'https://gateway.fpts.com.vn/news/api/gateway/v1/mobile/list?folder=86&code=D2D&pageSize=8&selectedPage=1&cbtt=1&from=01-01-1970&to=01-01-3000&newsType=1'
        ] 
    ...
    def parse(self, response):
        """Xử lý response JSON và lưu vào database."""
        # 1. Kết nối SQLite
        ...
        try:
            ...
            # Truy cập đúng vào cấu trúc Table1 của FPTS
...
def convert_date_to_iso8601(vietnam_date_str):
    ...
    try:
        ...
        clean_date_str = vietnam_date_str.strip()
        date_object = datetime.strptime(clean_date_str, input_format)
        return date_object.strftime(output_format)
    except ValueError as e:
        # Dự phòng trường hợp định dạng ngày chỉ có ngày tháng năm
        try:
