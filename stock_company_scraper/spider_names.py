...
SPIDER_PIV = 'event_piv' # fix date none #fixx ngừng hok build
...
SPIDER_VCI = 'event_vci'
SPIDER_HCM = 'event_hcm'
SPIDER_VND = 'event_vnd'
SPIDER_VIX = 'event_vix'
SPIDER_TCI = 'event_tci'
SPIDER_MBS = 'event_mbs'#dùng wright
SPIDER_SBS = 'event_sbs'
SPIDER_APS = 'event_aps'
SPIDER_VFS = 'event_vfs'
...
SPIDER_DSE = 'event_dse'
SPIDER_IVS = 'event_ivs'
SPIDER_ORS = 'event_ors'
SPIDER_VCK = 'event_vck'
...
SPIDER_VSC = 'event_vsc'
SPIDER_CDN = 'event_cdn'
SPIDER_DVP = 'event_dvp'
SPIDER_SGP = 'event_sgp'
SPIDER_DXP = 'event_dxp'
SPIDER_GMD = 'event_gmd'
...
ALL_SPIDERS = [ SPIDER_TLG, SPIDER_CAT, SPIDER_VOS,SPIDER_KBC,SPIDER_CII,
               ...
               SPIDER_BMC,SPIDER_KSV,SPIDER_C32,SPIDER_KCB,SPIDER_PGB,
               SPIDER_FIR,SPIDER_VHM,SPIDER_NDN,SPIDER_VRE,SPIDER_G36,SPIDER_NNC,
